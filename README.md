...
Sou um desenvolvedor Full Stack apaixonado por tecnologia, inovação e desafios. Gosto de criar aplicações web modernas, APIs robustas e integrações eficientes, sempre buscando entregar soluções escaláveis e de alta qualidade.

Tenho experiência com as principais linguagens e frameworks do mercado, tanto no frontend quanto no backend. Também atuo com DevOps, bancos de dados relacionais e NoSQL, cloud e automação. Trabalho com metodologias ágeis, foco em boas práticas, Clean Code e testes automatizados.

Meu objetivo é construir aplicações que impactem positivamente pessoas e negócios, aprender novas tecnologias e colaborar em projetos inovadores. Adoro compartilhar conhecimento, contribuir com a comunidade e estou sempre aberto a novos desafios e oportunidades.
